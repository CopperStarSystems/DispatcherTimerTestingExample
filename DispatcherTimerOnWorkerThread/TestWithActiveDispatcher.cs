...
{
    abstract class TestWithActiveDispatcher
    {
        #region Data
        ...
        protected void BeginExecuteTest()
        {
            ...
            // this method continues executing.
        ...
        {
            Debug.Assert(Thread.CurrentThread.Name == WORKER_THREAD_NAME);
        ...
        /// <summary>
        /// Stops the worker thread's message pump.
